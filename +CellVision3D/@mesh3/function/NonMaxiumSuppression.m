function [ strongpts ] = NonMaxiumSuppression( l1,l2,l3,v1,th,img)
...
addweak = SurfEdge3( strongpts, v1, dirth) & weakpts;
while sum(addweak(:))>0
    strongpts = strongpts | addweak;
    weakpts = weakpts & ~addweak;
    addweak = SurfEdge3( strongpts, v1, dirth ,zxr,dirmat,inddiff) & weakpts;
end
