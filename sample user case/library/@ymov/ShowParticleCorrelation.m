function [ obj ] = ShowParticleCorrelation( obj, channels, varargin)
%Plot the particle motion correlation analysis
%based on channels, channels cell for channel name string
% first channel main channel

%%
for imod=1:nargin-2
    % mod for fission yeast SPB and lacO operator analysis
    if strcmp(varargin{imod},'fissionyeast_SPB_other')
        ...
        for icell=1:obj.numdata
            ...
            if 1
                ...
                %plot 1d oscilation
                subplot(1,2,2)
                plot(1:obj.numframes,l1,1:obj.numframes,l2);
                pause
                close all
            end
        end
